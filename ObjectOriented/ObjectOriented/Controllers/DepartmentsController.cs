...
namespace ObjectOriented.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            var uniqueId = Guid.NewGuid().ToString();
            Department newDep = new Models.Department();
            newDep.DepId = uniqueId;
        ...
        public ActionResult Create([Bind(Include = "DepId,Name")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepId,Name")] Department department)
        {
            if (ModelState.IsValid)
            {
